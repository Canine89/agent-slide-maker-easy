...
```
.claude/skills/hyperframes-overview/
├── SKILL.md         (이 파일)
...
```bash
bash .claude/skills/hyperframes-overview/serve.sh topics/<주제>
# 또는 포트 지정
bash .claude/skills/hyperframes-overview/serve.sh topics/<주제> 9000
```
