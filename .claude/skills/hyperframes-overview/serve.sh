...
#
# Usage:
#   bash .claude/skills/hyperframes-overview/serve.sh <topic-path> [port]
#
# Examples:
#   bash .claude/skills/hyperframes-overview/serve.sh topics/apple-history
#   bash .claude/skills/hyperframes-overview/serve.sh topics/apple-history 8765
